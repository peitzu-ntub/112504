...
<body>
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <center>
          <div align="left"><img src="../images/購物車.png" />　<font size="6">購物車</font></div>
        </center>
      </div>
    </div>
    <div>
      <table width="100%">
        <tr>
          <td style="background-color:#b5c4b1" align="center" width="3%"></td>
          ...
          <td style="background-color:#b5c4b1" align="center" width="35%"><font color="black"><b>數量</b></font></td>
...
<?php
    ...
    echo "
        <tr>
            <td style='background-color:#b5c4b1' align='right' colspan='4'><b>合計</b></td>
